...
from constants import screen, GREEN, DARK_GREEN, cell_size, number_of_cells, OFFSET, font, screen_width, screen_height, PROJECT_ROOT, BLACK 
import pygame
import sys 
import json 
import os 
...
class Game:
    ...
    def draw_countdown(self):
        ...
        # Thử tạo font lớn
        try: big_font = pygame.font.Font(font, 150) # Dùng font game nếu được
