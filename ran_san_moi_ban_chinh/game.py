...
class Game:
    ...
    def save_current_game(self):
        ...
        data = {
            # Lưu cái map đang chơi dở (gameplay_map_name), chứ không phải map nền
    ...
    def game_over(self):
        if self.game_running: 
            ...
            # [SỬA QUAN TRỌNG] Chuyển về Kinh điển để hiển thị, NHƯNG KHÔNG lưu nó là map chính
            # is_gameplay=False -> game sẽ vẫn nhớ map cũ là "Cối xay"
